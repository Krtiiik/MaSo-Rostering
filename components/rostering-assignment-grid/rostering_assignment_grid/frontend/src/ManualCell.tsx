 ...
 * when provided, or, if `dropId` is set, dragged in) or a hand-typed name
 * for someone unregistered — manual roles are commonly filled by people who
 ...
 * not a move. Building-scoped duplicate-drop cells (`rooms` left null)
