...
# overlay roles that accept dragging a helper's existing chip onto the cell
# for their own room (scope "room") or building (scope "building") to
# duplicate them into that overlay slot (without moving their solved
# assignment) in addition to typing a name.
_MANUAL_ROWS_BEFORE = [
